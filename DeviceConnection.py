...
print "Now sending serial data" + "\n"


testData = []
testData.append("<0,0,255,255>")
testData.append("<2,0,255,0>")
testData.append("<3,0,0,255>")
